...
namespace Shared.AI.NavigationTargets
{
    ...
    public class TransformNavigationTarget : INavigationTarget
    {
        ...
        /// <param name="useTargetOrientation">
        /// True means that target's transform orientation will be taken into account when calculating target, false means
        /// that the orientation does not matter.
        /// </param>
        ...
        public void GetTarget(Vector3 currentPosition, float currentYaw, out Vector3 targetPosition, out float? targetYaw)
        {
            ...
            targetYaw = _useTargetOrientation ? _transform.rotation.eulerAngles.y : null;
        }
    }
}